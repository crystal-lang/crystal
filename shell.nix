...
let
  ...
  latestCrystalBinary = genericBinary ({
    x86_64-darwin = {
      url = "https://github.com/crystal-lang/crystal/releases/download/1.18.1/crystal-1.18.1-1-darwin-universal.tar.gz";
      sha256 = "sha256:0g93345ax65nyczbij81aib26vqr54annp82y1hb1jrxdpk18p03";
    };
    ...
    x86_64-linux = {
      url = "https://github.com/crystal-lang/crystal/releases/download/1.18.1/crystal-1.18.1-1-linux-x86_64.tar.gz";
      sha256 = "sha256:0pp6nk5bz0107099ahxjymxqv04xix0k7428k4mak87845h1yqby";
    };
  }.${pkgs.stdenv.system});
