...
reach huge compile times, but that's no excuse either for us to do the same.
...
adding 30 type annotations at once instead of doing them when declaring a class is definitely more annoying.
...
There are no official releases yet, but they will certainly come soon.
