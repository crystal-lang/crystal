...
describe Parser do
  ...
  it_parses "lib C; fun foo(a : Int*); end", LibDef.new('C', nil, [FunDef.new('foo', [FunDefArg.new('a', 'Int'.ident, true)])])
  ...
  it_parses "lib C; struct Foo; x : Int*; end end", LibDef.new('C', nil, [StructDef.new('Foo', [FunDefArg.new('x', 'Int'.ident, true)])])
