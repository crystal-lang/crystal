...
describe Parser do
  ...
  it_parses "begin; 1; ensure; 2; end", ExceptionHandler.new(1.int32, [], 2.int32)
  it_parses "begin\n1\nensure\n2\nend", ExceptionHandler.new(1.int32, [], 2.int32)
  ...
  it_parses "begin; 1; rescue => ex; 2; end", ExceptionHandler.new(1.int32, [Rescue.new(2.int32, [], "ex")])
