...
describe Parser do
  ...
  it_parses "lib C; fun foo(a : ptr Int); end", LibDef.new('C', nil, [FunDef.new('foo', [FunDefArg.new('a', 'Int'.ident, ptr: true)])])
  it_parses "lib C; fun foo : ptr Int; end", LibDef.new('C', nil, [FunDef.new('foo', [], 'Int'.ident, true)])
  it_parses "lib C; type A : B; end", LibDef.new('C', nil, [TypeDef.new('A', 'B'.ident)])
  it_parses "lib C; type A : ptr B; end", LibDef.new('C', nil, [TypeDef.new('A', 'B'.ident, true)])
