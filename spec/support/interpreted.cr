...
{% if flag?(:interpreted) %}
  def pending_interpreted(description = "assert", file : String = __FILE__, line : Int32 = __LINE__, end_line : Int32 = __END_LINE__, &block)
    pending("#{description} [interpreted]", file, line, end_line)
  end

  def pending_interpreted(*, describe, file : String = __FILE__, line : Int32 = __LINE__, end_line : Int32 = __END_LINE__, &block)
