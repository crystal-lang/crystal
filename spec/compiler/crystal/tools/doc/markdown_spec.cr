...
describe Crystal::Doc::Markdown do
  ...
  assert_render "Hello\n=", "<h1>#{Crystal::Doc.anchor_link "hello"}Hello</h1>"
  assert_render "Hello\n===", "<h1>#{Crystal::Doc.anchor_link "hello"}Hello</h1>"
  assert_render "Hello\n===\nWorld", "<h1>#{Crystal::Doc.anchor_link "hello"}Hello</h1>\n\n<p>World</p>"
  assert_render "Hello\n===World", "<p>Hello\n===World</p>"

  assert_render "Hello\n-", "<h2>#{Crystal::Doc.anchor_link "hello"}Hello</h2>"
  assert_render "Hello\n-", "<h2>#{Crystal::Doc.anchor_link "hello"}Hello</h2>"
  assert_render "Hello\n-World", "<p>Hello\n-World</p>"

  assert_render "#Hello", "<h1>#{Crystal::Doc.anchor_link "hello"}Hello</h1>"
  assert_render "#   Hello  ", "<h1>#{Crystal::Doc.anchor_link "hello"}Hello  </h1>"
  assert_render "#Hel%^&|>/\\lo", "<h1>#{Crystal::Doc.anchor_link "hello"}Hel%^&|>/\\lo</h1>"
  assert_render "# Hello", "<h1>#{Crystal::Doc.anchor_link "hello"}Hello</h1>"
  assert_render "#    Hello", "<h1>#{Crystal::Doc.anchor_link "hello"}Hello</h1>"
  ...
  assert_render "## Foo: Bar", "<h2>#{Crystal::Doc.anchor_link "foo-bar"}Foo: Bar</h2>"
  ...
  assert_render "###### Hello", "<h6>#{Crystal::Doc.anchor_link "hello"}Hello</h6>"
  assert_render "####### Hello", "<h6>#{Crystal::Doc.anchor_link "hello"}# Hello</h6>"
