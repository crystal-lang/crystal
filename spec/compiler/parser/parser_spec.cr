...
describe "Parser" do
  ...
  it_parses "def foo; a.yield; end", Def.new("foo", [] of Arg, [Yield.new([] of ASTNode, "a".call)] of ASTNode, nil, nil, nil, 1)
  it_parses "def foo; a.yield 1; end", Def.new("foo", [] of Arg, [Yield.new([1.int32] of ASTNode, "a".call)] of ASTNode, nil, nil, nil, 1)
