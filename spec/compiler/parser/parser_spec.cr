...
private def it_parses(string, expected_node, file = __FILE__, line = __LINE__, *, focus : Bool = false)
  it "parses #{string.dump}", file, line, focus: focus do
    parser = Parser.new(string, spec_ident_pool)
...
private def assert_end_location(source, line_number = 1, column_number = source.size, file = __FILE__, line = __LINE__)
  it "gets corrects end location for #{source.inspect}", file, line do
    parser = Parser.new("#{source}; 1", spec_ident_pool)
...
module Crystal
  describe "Parser" do
    ...
    it_parses "1 + 2", Call.new(1.int32, "+".i, 2.int32)
    it_parses "1 +\n2", Call.new(1.int32, "+".i, 2.int32)
    it_parses "1 +2", Call.new(1.int32, "+".i, 2.int32)
    it_parses "1 -2", Call.new(1.int32, "-".i, 2.int32)
    it_parses "1 +2.0", Call.new(1.int32, "+".i, 2.float64)
    it_parses "1 -2.0", Call.new(1.int32, "-".i, 2.float64)
    it_parses "1 +2_i64", Call.new(1.int32, "+".i, 2.int64)
    it_parses "1 -2_i64", Call.new(1.int32, "-".i, 2.int64)
    ...
    it_parses "1 * 2", Call.new(1.int32, "*".i, 2.int32)
    it_parses "1 * -2", Call.new(1.int32, "*".i, -2.int32)
    it_parses "2 * 3 + 4 * 5", Call.new(Call.new(2.int32, "*".i, 3.int32), "+".i, Call.new(4.int32, "*".i, 5.int32))
    it_parses "1 / 2", Call.new(1.int32, "/".i, 2.int32)
    it_parses "1 / -2", Call.new(1.int32, "/".i, -2.int32)
    it_parses "2 / 3 + 4 / 5", Call.new(Call.new(2.int32, "/".i, 3.int32), "+".i, Call.new(4.int32, "/".i, 5.int32))
    it_parses "2 * (3 + 4)", Call.new(2.int32, "*".i, Expressions.new([Call.new(3.int32, "+".i, 4.int32)] of ASTNode))
    it_parses "a = 1; b = 2; c = 3; a-b-c", Expressions.new([
      Assign.new("a".var, 1.int32),
      Assign.new("b".var, 2.int32),
      Assign.new("c".var, 3.int32),
      Call.new(Call.new("a".var, "-".i, "b".var), "-".i, "c".var),
    ])
    it_parses "a = 1; b = 2; c = 3; a-b -c", Expressions.new([
      Assign.new("a".var, 1.int32),
      Assign.new("b".var, 2.int32),
    ...
    it_parses "1/2", Call.new(1.int32, "/".i, [2.int32] of ASTNode)
    it_parses "1 + /foo/", Call.new(1.int32, "+".i, regex("foo"))
    it_parses "1+0", Call.new(1.int32, "+".i, 0.int32)
    it_parses "a = 1; a /b", [Assign.new("a".var, 1.int32), Call.new("a".var, "/".i, "b".call)]
    it_parses "a = 1; a/b", [Assign.new("a".var, 1.int32), Call.new("a".var, "/".i, "b".call)]
    it_parses "a = 1; (a)/b", [Assign.new("a".var, 1.int32), Call.new(Expressions.new(["a".var] of ASTNode), "/".i, "b".call)]
    it_parses "_ = 1", Assign.new(Underscore.new, 1.int32)
    it_parses "@foo/2", Call.new("@foo".instance_var, "/".i, 2.int32)
    it_parses "@@foo/2", Call.new("@@foo".class_var, "/".i, 2.int32)
    it_parses "1+2*3", Call.new(1.int32, "+".i, Call.new(2.int32, "*".i, 3.int32))
    it_parses "foo[] /2", Call.new(Call.new("foo".call, "[]".i), "/".i, 2.int32)
    it_parses "foo[1] /2", Call.new(Call.new("foo".call, "[]".i, 1.int32), "/".i, 2.int32)
    it_parses "[1] /2", Call.new(([1.int32] of ASTNode).array, "/".i, 2.int32)
    it_parses "2**3**4", Call.new(2.int32, "**".i, Call.new(3.int32, "**".i, 4.int32))

    it_parses "!1", Not.new(1.int32)
    it_parses "- 1", Call.new(1.int32, "-".i)
    it_parses "+ 1", Call.new(1.int32, "+".i)
    it_parses "~ 1", Call.new(1.int32, "~".i)
    it_parses "1.~", Call.new(1.int32, "~".i)
    it_parses "1.!", Not.new(1.int32)
    ...
    it_parses "a[0], a[1] = 1, 2", MultiAssign.new([Call.new("a".call, "[]".i, 0.int32), Call.new("a".call, "[]".i, 1.int32)] of ASTNode, [1.int32, 2.int32] of ASTNode)
    it_parses "a.foo, a.bar = 1, 2", MultiAssign.new([Call.new("a".call, "foo".i), Call.new("a".call, "bar".i)] of ASTNode, [1.int32, 2.int32] of ASTNode)
    it_parses "x = 0; a, b = x += 1", [Assign.new("x".var, 0.int32), MultiAssign.new(["a".var, "b".var] of ASTNode, [OpAssign.new("x".var, "+".i, 1.int32)] of ASTNode)] of ASTNode
    ...
    it_parses "*a.foo, a.bar = 1", MultiAssign.new([Call.new("a".call, "foo".i).splat, Call.new("a".call, "bar".i)] of ASTNode, [1.int32] of ASTNode)
    it_parses "a.foo, *a.bar = 1", MultiAssign.new([Call.new("a".call, "foo".i), Call.new("a".call, "bar".i).splat] of ASTNode, [1.int32] of ASTNode)
    ...
    it_parses "あ.い, う.え.お = 1, 2", MultiAssign.new([Call.new("あ".call, "い".i), Call.new(Call.new("う".call, "え".i), "お".i)] of ASTNode, [1.int32, 2.int32] of ASTNode)
    ...
    it_parses "def foo\n1\nend", Def.new("foo".i, body: 1.int32)
    it_parses "def downto(n)\n1\nend", Def.new("downto".i, ["n".arg], 1.int32)
    it_parses "def foo ; 1 ; end", Def.new("foo".i, body: 1.int32)
    it_parses "def foo; end", Def.new("foo".i)
    it_parses "def foo(var); end", Def.new("foo".i, ["var".arg])
    it_parses "def foo(\nvar); end", Def.new("foo".i, ["var".arg])
    it_parses "def foo(\nvar\n); end", Def.new("foo".i, ["var".arg])
    it_parses "def foo(var1, var2); end", Def.new("foo".i, ["var1".arg, "var2".arg])
    it_parses "def foo; 1; 2; end", Def.new("foo".i, body: [1.int32, 2.int32] of ASTNode)
    it_parses "def foo=(value); end", Def.new("foo=".i, ["value".arg])
    it_parses "def foo(n); foo(n -1); end", Def.new("foo".i, ["n".arg], "foo".call(Call.new("n".var, "-".i, 1.int32)))
    it_parses "def type(type); end", Def.new("type".i, ["type".arg])
    ...
    %w(
      ...
      it_parses "def foo(#{kw} foo); end", Def.new("foo".i, [Arg.new("foo".i, external_name: kw.to_s.i)])
      it_parses "def foo(@#{kw}); end", Def.new("foo".i, [Arg.new("__arg0".i, external_name: kw.to_s.i)], [Assign.new("@#{kw}".instance_var, "__arg0".var)] of ASTNode)
      it_parses "def foo(@@#{kw}); end", Def.new("foo".i, [Arg.new("__arg0".i, external_name: kw.to_s.i)], [Assign.new("@@#{kw}".class_var, "__arg0".var)] of ASTNode)
    ...
    it_parses "def self.foo\n1\nend", Def.new("foo".i, body: 1.int32, receiver: "self".var)
    it_parses "def self.foo()\n1\nend", Def.new("foo".i, body: 1.int32, receiver: "self".var)
    it_parses "def self.foo=\n1\nend", Def.new("foo=".i, body: 1.int32, receiver: "self".var)
    it_parses "def self.foo=()\n1\nend", Def.new("foo=".i, body: 1.int32, receiver: "self".var)
    it_parses "def Foo.foo\n1\nend", Def.new("foo".i, body: 1.int32, receiver: "Foo".path)
    it_parses "def Foo::Bar.foo\n1\nend", Def.new("foo".i, body: 1.int32, receiver: ["Foo", "Bar"].path)

    it_parses "def foo; a; end", Def.new("foo".i, body: "a".call)
    it_parses "def foo(a); a; end", Def.new("foo".i, ["a".arg], "a".var)
    it_parses "def foo; a = 1; a; end", Def.new("foo".i, body: [Assign.new("a".var, 1.int32), "a".var] of ASTNode)
    it_parses "def foo; a = 1; a {}; end", Def.new("foo".i, body: [Assign.new("a".var, 1.int32), Call.new(nil, "a".i, block: Block.new)] of ASTNode)
    it_parses "def foo; a = 1; x { a }; end", Def.new("foo".i, body: [Assign.new("a".var, 1.int32), Call.new(nil, "x".i, block: Block.new(body: ["a".var] of ASTNode))] of ASTNode)
    it_parses "def foo; x { |a| a }; end", Def.new("foo".i, body: [Call.new(nil, "x".i, block: Block.new(["a".var], ["a".var] of ASTNode))] of ASTNode)
    it_parses "def foo; x { |_| 1 }; end", Def.new("foo".i, body: [Call.new(nil, "x".i, block: Block.new(["_".var], [1.int32] of ASTNode))] of ASTNode)
    it_parses "def foo; x { |a, *b| b }; end", Def.new("foo".i, body: [Call.new(nil, "x".i, block: Block.new(["a".var, "b".var], ["b".var] of ASTNode, splat_index: 1))] of ASTNode)
