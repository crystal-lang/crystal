...
describe "Parser" do
  ...
  it_parses "select\nwhen foo\n2\nend", Crystal::Select.new([Crystal::Select::When.new("foo".call, 2.int32)])
  it_parses "select\nwhen foo\n2\nwhen bar\n4\nend", Crystal::Select.new([Crystal::Select::When.new("foo".call, 2.int32), Crystal::Select::When.new("bar".call, 4.int32)])
  it_parses "select\nwhen foo\n2\nelse\n3\nend", Crystal::Select.new([Crystal::Select::When.new("foo".call, 2.int32)], 3.int32)
