...
module Crystal
  describe "Parser" do
    ...
    it_parses "def foo(var : (Int | Double)); end", Def.new("foo", [Arg.new("var", restriction: Crystal::Union.new(Crystal::Union.new(["Int".path, "Double".path] of ASTNode)))])
    ...
    it_parses "def foo(var : (Int, Float -> Double)); end", Def.new("foo", [Arg.new("var", restriction: Crystal::Union.new(ProcNotation.new(["Int".path, "Float".path] of ASTNode, "Double".path)))])
    it_parses "def foo(var : (Int, Float) -> Double); end", Def.new("foo", [Arg.new("var", restriction: ProcNotation.new(["Int".path, "Float".path] of ASTNode, "Double".path))])
    it_parses "def foo(var : () -> Double); end", Def.new("foo", [Arg.new("var", restriction: ProcNotation.new([] of ASTNode, "Double".path))])
    it_parses "x : (A -> B)", TypeDeclaration.new("x".var, declared_type: Crystal::Union.new(ProcNotation.new(["A".path] of ASTNode, "B".path)))
    it_parses "x : (A -> B).class", TypeDeclaration.new("x".var, declared_type: Metaclass.new(Crystal::Union.new(ProcNotation.new(["A".path] of ASTNode, "B".path))))
    it_parses "alias T = (A*) -> R", Alias.new("T".path, ProcNotation.new([Crystal::Union.new(Generic.new(Path.global("Pointer"), ["A".path] of ASTNode, suffix: :asterisk))] of ASTNode, "R".path))
    it_parses "alias T = (A -> ) ->", Alias.new("T".path, ProcNotation.new([Crystal::Union.new(ProcNotation.new(["A".path] of ASTNode))] of ASTNode))
    ...
    it_parses "lib LibC\nfun getchar : (->)?\nend", LibDef.new("LibC".path, [FunDef.new("getchar", return_type: Crystal::Union.new([Crystal::Union.new(ProcNotation.new), "Nil".path(true)] of ASTNode))] of ASTNode)
    it_parses "lib LibC\nfun getchar : ((->))?\nend", LibDef.new("LibC".path, [FunDef.new("getchar", return_type: Crystal::Union.new([Crystal::Union.new(Crystal::Union.new(ProcNotation.new)), "Nil".path(true)] of ASTNode))] of ASTNode)
