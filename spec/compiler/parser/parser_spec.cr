...
module Crystal
  describe "Parser" do
    ...
    it_parses "x : (A -> B)", TypeDeclaration.new("x".var, declared_type: ProcNotation.new(["A".path] of ASTNode, "B".path))
    it_parses "x : (A -> B).class", TypeDeclaration.new("x".var, declared_type: Metaclass.new(ProcNotation.new(["A".path] of ASTNode, "B".path)))
