...
describe Socket::IPAddress do
  ...
  it "#loopback?" do
    Socket::IPAddress.new("127.0.0.1", 0).assert &.loopback?
    Socket::IPAddress.new("127.255.255.254", 0).assert &.loopback?
    Socket::IPAddress.new("128.0.0.1", 0).refute &.loopback?
    Socket::IPAddress.new("0.0.0.0", 0).refute &.loopback?
    Socket::IPAddress.new("::1", 0).assert &.loopback?
    Socket::IPAddress.new("0000:0000:0000:0000:0000:0000:0000:0001", 0).assert &.loopback?
    Socket::IPAddress.new("::2", 0).refute &.loopback?
    Socket::IPAddress.new(Socket::IPAddress::LOOPBACK, 0).assert &.loopback?
    Socket::IPAddress.new(Socket::IPAddress::LOOPBACK6, 0).assert &.loopback?
  end

  it "#unspecified?" do
    Socket::IPAddress.new("0.0.0.0", 0).assert &.unspecified?
    Socket::IPAddress.new("127.0.0.1", 0).refute &.unspecified?
    Socket::IPAddress.new("::", 0).assert &.unspecified?
    Socket::IPAddress.new("0000:0000:0000:0000:0000:0000:0000:0000", 0).assert &.unspecified?
    Socket::IPAddress.new(Socket::IPAddress::UNSPECIFIED, 0).assert &.unspecified?
    Socket::IPAddress.new(Socket::IPAddress::UNSPECIFIED6, 0).assert &.unspecified?
  end
end
