## FIXME: Enabling this spec file sometimes causes a segfault during a GC malloc
## atomic while running specs in an ExecutionContext::MultiThreaded context (ie.
## :execution_context + :preview_mt + :mt).
#
...
#  #   it "#stack_pool" do
#  #     test = ExecutionContext::Isolated.new("TEST-SP") { }
#  #     expect_raises(NotImplementedError) { test.stack_pool }
#  #   end
#
#  #   it "#execution_context" do
#  #     test = ExecutionContext::Isolated.new("TEST-EC") { }
...
#
#  #     ExecutionContext::Isolated.new("TEST-SD") do
#  #       spawn do
...
#
#  #     test = ExecutionContext::Isolated.new("TEST-ENQ") do
#  #       sleep
#  #       # timeout.cancel
#  #     end
...
#  #     test = ExecutionContext::Isolated.new("TEST-ENQ-RAISE") { sleep }
#  #     fiber = Fiber.new { }
...
#    timeout = ExecutionContext::TestTimeout.new(1.second)
#
#    ExecutionContext::Isolated.new("TEST-WAIT") do
