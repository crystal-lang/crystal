  ...
  describe X86 do
    ...
    describe "align" do
      it "for integer" do
        ...
        abi.align(LLVM::Int64).should eq(4)
      end
      ...
      it "for double" do
        abi.align(LLVM::Double).should eq(4)
      end

      it "for struct" do
        abi.align(LLVM::Type.struct([LLVM::Int32, LLVM::Int64])).should eq(4)
    ...
    describe "size" do
      ...
      it "for struct" do
        abi.size(LLVM::Type.struct([LLVM::Int32, LLVM::Int64])).should eq(12)
