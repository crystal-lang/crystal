...
describe "Random" do
  ...
  it "raises on invalid range" do
    ...
    expect_raises ArgumentError, "incorrect rand value: 1..0" do
      rand(1..0)
    end
    expect_raises ArgumentError, "incorrect rand value: 1.0...1.0" do
      rand(1.0...1.0)
    end
    expect_raises ArgumentError, "incorrect rand value: 1.0..0.0" do
      rand(1.0..0.0)
    end
  end
