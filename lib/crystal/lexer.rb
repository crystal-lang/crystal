...
module Crystal
  class Lexer < StringScanner
    ...
    def next_token
      ...
      elsif match = scan(/(def|do|elsif|else|end|if|true|false|class|module|include|while|nil|yield|return|unless|next|break|begin|lib|fun|type|struct|macro|ptr|out|require)((\?|!)|\b)/)
        @token.type = :IDENT
