...
module Crystal
  class Lexer < StringScanner
    ...
    def next_token
      ...
      elsif match = scan(/(abstract|def|do|elsif|else|end|if|true|false|class|module|include|while|nil|yield|return|unless|next|break|begin|lib|fun|type|struct|macro|out|require|case|when|then|of)((\?|!)|\b)/)
        @token.type = :IDENT
