...
describe "Parser" do
  ...
  # it_parses "def Foo.foo\n1\nend", Def.new("foo", ASTNode[], [1.int], "Foo".ident)
  # it_parses "def Foo::Bar.foo\n1\nend", Def.new("foo", ASTNode[], [1.int], ["Foo", "Bar"].ident)

  # it_parses "def foo; a; end", Def.new("foo", ASTNode[], ["a".call])
  # it_parses "def foo(a); a; end", Def.new("foo", ["a".arg], ["a".var])
  # it_parses "def foo; a = 1; a; end", Def.new("foo", ASTNode[], [Assign.new("a".var, 1.int), "a".var])
  # it_parses "def foo; a = 1; a {}; end", Def.new("foo", ASTNode[], [Assign.new("a".var, 1.int), Call.new(nil, "a", ASTNode[], Block.new)])
  # it_parses "def foo; a = 1; x { a }; end", Def.new("foo", ASTNode[], [Assign.new("a".var, 1.int), Call.new(nil, "x", ASTNode[], Block.new(ASTNode[], ["a".var]))])
  # it_parses "def foo; x { |a| a }; end", Def.new("foo", ASTNode[], [Call.new(nil, "x", ASTNode[], Block.new(["a".var], ["a".var]))])
