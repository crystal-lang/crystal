...
abstract class IO
  ...
  def puts(*objects : _) : Nil
   ...
   # <code>printf</code> argument is to be interpreted, while the flags
   ...
   #
   # ```
   # printf "%a", 123 #=> "0x1.ecp+6"
   # printf "%A", 123 #=> "0X1.ECP+6"
   # ```
   #
   # ```
   # printf "%g", 123.4          #=> "123.4"
   # printf "%g", 123.4567       #=> "123.457"
   # printf "%20.8g", 1234.56789 #=> "           1234.5679"
   # printf "%20.8g", 123456789  #=> "       1.2345679e+08"
   # printf "%20.8G", 123456789  #=> "       1.2345679E+08"
   # printf "%20.8g", -123456789 #=> "       -1.2345679e+08"
   # printf "%20.8G", -123456789 #=> "       -1.2345679E+08"
   # ```
   ...
   # printf "%20d", 123   #=> "                 123"
   # printf "%+20d", 123  #=> "                +123"
   # printf "%020d", 123  #=> "00000000000000000123"
   # printf "%+020d", 12  #=> "+0000000000000000123"
   # printf "% 020d", 123 #=> " 0000000000000000123"
   # printf "%-20d", 123  #=> "123                 "
   # printf "%-+20d", 123 #=> "+123                "
   # printf "%- 20d", 123 #=> " 123                "
   # printf "%020x", -123 #=> "00000000000000000-7b"
   # printf "%020X", -123 #=> "00000000000000000-7B"
   # ```
   #
   ...
   # ```
   # printf "%20.8d", 123  #=> "                 123"
   # printf "%020.8d", 123  #=> "00000000000000000123"
   # printf "%20.8o", 123  #=> "                 173"
   # printf "%020.8o", 123  #=> "00000000000000000173"
   # printf "%20.8x", 123  #=> "                  7b"
   # printf "%020.8x", 123  #=> "0000000000000000007b"
   # printf "%20.8b", 123  #=> "            01111011"
   # printf "%20.8d", -123 #=> "                -123"
   # printf "%020.8d", -123 #=> "0000000000000000-123"
   # printf "%20.8o", -123 #=> "                -173"
   # printf "%20.8x", -123 #=> "                 -7b"
   # printf "%20.8b", -11  #=> "               -1011"
   # ```
   #
   # precision for `e` is number of
   # digits after the decimal point
   # ```
   # printf "%20.8e", 1234.56789 #=> "      1.23456789e+03"
   # ```
   #
   # precision for `f` is number of
   # digits after the decimal point
   # ```
   # printf "%20.8f", 1234.56789 #=> "       1234.56789000"
   # ```
   ...
   # ```
   # printf "%20.8s", "string test" #=> "            string t"
   # ```
   # Examples:
   #
   # ```
