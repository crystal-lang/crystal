...
class HTTP::Server
  ...
  class Response < IO
    ...
    protected def write_headers : Bool
    ...
    protected def wrote_headers? : Bool
      @wrote_headers
    end

    protected def has_cookies? : Bool
      !@cookies.nil?
    end
    ...
    class Output < IO
      ...
      private def ensure_headers_written : Bool?
