...
class Thread
  ...
  class Mutex
    def initialize
      ...
      raise RuntimeError.from_errno("pthread_mutex_init", Errno.new(ret.to_i)) unless ret == 0
    ...
    def lock
      ...
      raise RuntimeError.from_errno("pthread_mutex_lock", Errno.new(ret.to_i!)) unless ret == 0
    end
    ...
    def unlock
      ...
      raise RuntimeError.from_errno("pthread_mutex_unlock", Errno.new(ret.to_i!)) unless ret == 0
    end
    ...
    def finalize
      ...
      raise RuntimeError.from_errno("pthread_mutex_destroy", Errno.new(ret.to_i!)) unless ret == 0
    end
