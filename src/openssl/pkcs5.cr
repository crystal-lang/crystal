...
module OpenSSL::PKCS5
  def self.pbkdf2_hmac_sha1(secret : String, salt : String, iterations : Int32 = 2**16, key_size : Int32 = 64) : Bytes
  ...
  def self.pbkdf2_hmac(secret : String, salt : String, iterations : Int32 = 2**16, algorithm : OpenSSL::Algorithm = OpenSSL::Algorithm::SHA1, key_size : Int32 = 64) : Bytes
