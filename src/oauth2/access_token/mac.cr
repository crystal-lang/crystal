...
class OAuth2::AccessToken::Mac < OAuth2::AccessToken
  ...
  def initialize(access_token : String, expires_in : Int64 | Nil | Int32, @mac_algorithm : String, @mac_key : String, refresh_token : String? = nil, scope : String? = nil, @issued_at : Int64 = Time.utc.to_unix, extra : Hash(String, String)? = nil)
  ...
  private def host_and_port(request : HTTP::Request, tls : Bool | Nil | OpenSSL::SSL::Context::Client) : Tuple(String, Int32)
