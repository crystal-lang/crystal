...
class Deflate::Reader < IO
  ...
  def unbuffered_write(slice : Bytes)
    raise IO::Error.new "Can't write to Deflate::Reader"
  end
  ...
  def unbuffered_read(slice : Bytes)
    ...
    while true
      ...
      when .need_dict?
        ...
        raise Deflate::Error.new(ret, @stream)
      when .errno?,
           .data_error?,
           .mem_error?,
           .buf_error?,
  ...
  def unbuffered_flush
    raise IO::Error.new "Can't flush Deflate::Reader"
  end
