module YAML
  ...
  module Serializable
    ...
    macro included
      ...
      def self.new(ctx : YAML::ParseContext, node : YAML::Nodes::Node, **opts)
        new_from_yaml_node(ctx, node, **opts)
      end

      private def self.new_from_yaml_node(ctx : YAML::ParseContext, node : YAML::Nodes::Node, **opts)
        ...
        instance.initialize(**opts, __context_for_yaml_serializable: ctx, __node_for_yaml_serializable: node)
    ...
    def initialize(*, __context_for_yaml_serializable ctx : YAML::ParseContext, __node_for_yaml_serializable node : ::YAML::Nodes::Node, **opts)
      {% begin %}
    ...
    protected def after_initialize(**opts)
    end
