...
# than `Random::Secure` and suitable for many use cases without
...
# to use `Random::Secure`. Depending on the security demands, other CSRPNG's
# like `Random::ISAAC` may be viable as well.
