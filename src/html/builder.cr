...
struct HTML::Builder
  ...
  {% for tag in %w(a b body button div em h1 h2 h3 head html i label li ol option p s script select span strong table tbody td textarea thead title tr u ul form) %}
