...
class String
  ...
  def to_i128(base : Int = 10, whitespace : Bool = true, underscore : Bool = false, prefix : Bool = false, strict : Bool = true, leading_zero_is_octal : Bool = false, &block)
    # Because Int128 literals are not supported in the current crystal version, this logic is used to get the minimum
    # TODO: Once a crystal version with Int128 support has been released, this can be changed to use literals
