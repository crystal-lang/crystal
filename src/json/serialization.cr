module JSON
  ...
  module Serializable
    ...
    macro included
      ...
      def self.new(pull : ::JSON::PullParser, **opts)
        new_from_json_pull_parser(pull, **opts)
      end

      private def self.new_from_json_pull_parser(pull : ::JSON::PullParser, **opts)
        instance = allocate
        instance.initialize(**opts, __pull_for_json_serializable: pull)
    ...
    def initialize(*, __pull_for_json_serializable pull : ::JSON::PullParser, **opts)
      {% begin %}
