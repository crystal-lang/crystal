...
class Process
  ...
  #
  # Note: Not all Unix and Unix deriviatives support a saved `User`. Calling
  # this method on a unsupported platform will result in a runtime error.
  ...
  #
  # Note: Not all Unix and Unix deriviatives support a saved `Group`. Calling
  # this method on a unsupported platform will result in a runtime error.
