...
class Process
  ...
  # * On Windows, this captures <kbd>Ctrl</kbd> + <kbd>C</kbd> and <kbd>Ctrl</kbd> + <kbd>Break</kbd> signals sent to a console
  #   application.
  ...
  #
  # * On Windows, interrupts generated by <kbd>Ctrl</kbd> + <kbd>Break</kbd> cannot be ignored in this
  # way.
  def self.on_interrupt(*, ignore : Bool) : Nil
    Crystal::System::Process.on_interrupt(ignore: ignore)
  end
