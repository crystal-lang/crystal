...
lib LibC
  ...
  alias TransmitFile = Proc(SOCKET, HANDLE, DWORD, DWORD, OVERLAPPED*, Void*, DWORD, Bool)
  alias WSAID_TRANSMITFILE = GUID.new(0xb5367df0, 0xcbac, 0x11cf, UInt8.static_array(0x95, 0xca, 0x00, 0x80, 0x5f, 0x48, 0xa1, 0x92))
end
