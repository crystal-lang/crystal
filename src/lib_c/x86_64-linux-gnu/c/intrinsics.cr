lib Intrinsics
  ...
  fun memcpy = "llvm.memcpy.p0i8.p0i8.i64"(dest : Void*, src : Void*, len : SizeT, align : UInt32, is_volatile : Bool)
  fun memmove = "llvm.memmove.p0i8.p0i8.i64"(dest : Void*, src : Void*, len : SizeT, align : UInt32, is_volatile : Bool)
  fun memset = "llvm.memset.p0i8.i64"(dest : Void*, val : UInt8, len : SizeT, align : UInt32, is_volatile : Bool)
end
