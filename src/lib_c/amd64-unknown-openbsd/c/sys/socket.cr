...
lib LibC
  ...
  PF_ROUTE      = AF_ROUTE
  PF_LINK       = AF_LINK
  PF_XTP        = AF_XTP_pseudo   # really just proto family, no AF
  PF_COIP       = AF_COIP
  PF_CNT        = AF_CNT
  PF_IPX        = AF_IPX          # same format as AF_NS
  PF_INET6      = AF_INET6
  PF_RTIP       = AF_RTIP_pseudo	# same format as AF_INET
  PF_PIP        = AF_PIP_pseudo
  PF_ISDN       = AF_ISDN
  PF_NATM       = AF_NATM
  PF_ENCAP      = AF_ENCAP
  PF_SIP        = AF_SIP
  PF_KEY        = AF_KEY
  PF_BPF        = AF_HDRCMPLT_pseudo
  PF_BLUETOOTH  = AF_BLUETOOTH
  PF_MPLS       = AF_MPLS
  PF_PFLOW      = AF_PFLOW_pseudo
  PF_PIPEX      = AF_PIPEX_pseudo
  PF_MAX        = AF_MAX
