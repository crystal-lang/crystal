module FileUtils
  ...
  # ```
  def ln(src_path : String, dest_path : String) : Nil
  ...
  # ```
  def ln_s(src_path : String, dest_path : String) : Nil
    if Dir.exists?(dest_path)
  ...
  # ```
  def ln_sf(src_path : String, dest_path : String) : Nil
